...
To add user-defined fields, you can provide these fields through a quarkus.properties file. Refer to the link:{links_server_configuration_url}[{links_server_configuration_name}]
