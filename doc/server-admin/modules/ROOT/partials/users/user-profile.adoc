...
image:user-profile-enabling.png[]
...
image:user-profile-create-attribute.png[]
...
image:user-profile-permission.png[]
...
image:user-profile-validation.png[]
...
This mechanism is used for example to xref:_configurin_form_input_field_for_attribute[configure Form input filed for attribute].

.Attribute Annotation
image:user-profile-annotation.png[]
...
image:user-profile-attribute-group-list.png[]
...
image:user-profile-create-attribute-group.png[]
...
.JSON Configuration
image:user-profile-json-config.png[]
...
.Ordering Attributes
image:user-profile-attribute-list-order.png[]
...
image:user-profile-update-profile.png[]
...
|Annotation for select and multiselect types. Optional name of custom attribute validation to get input options from. See xref:_managing_options_for_select_fields[detailed description] below.

|inputOptionLabelsI18nPrefix
|Annotation for select and multiselect types. Internationalization key prefix to render options in UI. See xref:_managing_options_for_select_fields[detailed description] below.

|inputOptionLabels
|Annotation for select and multiselect types. Optional map to define UI labels for options (directly or using internationalization). See xref:_managing_options_for_select_fields[detailed description] below.
...
|select
|Common single select input. See xref:_managing_options_for_select_fields[description how to configure options] below.
|select

|select-radiobuttons
|Single select input through group of radio buttons. See xref:_managing_options_for_select_fields[description how to configure options] below.
|group of input

|multiselect
|Common multiselect input. See xref:_managing_options_for_select_fields[description how to configure options] below.
|select

|multiselect-checkboxes
|Multiselect input through group of checkboxes. See xref:_managing_options_for_select_fields[description how to configure options] below.
|group of input
...
image:user-profile-select-options-simple.png[]
...
image:user-profile-select-options-simple-i18n.png[]
...
image:user-profile-select-options-custom-validator.png[]
...
image:user-profile-register-verify-profile-action.png[]
