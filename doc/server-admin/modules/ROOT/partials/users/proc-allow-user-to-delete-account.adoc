[id="proc-allow-user-to-delete-account"]
...
image:enable-delete-account-action.png[]
...
+
.Delete-account role
image:delete-account-client-role.png[delete-account role]
...
+
.Delete account page
image:delete-account-page.png[Delete account page]

. Enter your credentials and confirm the deletion.
+
.Delete confirmation
image:delete-account-confirm.png[]
+
[NOTE]
====
