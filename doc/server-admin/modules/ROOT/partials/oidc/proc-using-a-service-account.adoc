...
In this situation, logout is unnecessary. However, issued access tokens can be revoked by sending requests to the OAuth2 Revocation Endpoint as described in the xref:sso-protocols.adoc#con-oidc[OpenID Connect Endpoints] section.

[role="_additional-resources"]
.Additional resources
For more details, see xref:sso-protocols.adoc#_client_credentials_grant[Client Credentials Grant].
