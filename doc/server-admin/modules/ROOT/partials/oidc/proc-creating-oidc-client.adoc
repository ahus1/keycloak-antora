...
+
.Create client
image:add-client-oidc.png[Create Client]
...
This action creates the client and bring you to the *Settings* tab, where you can perform xref:con-basic-settings[Basic configuration].
