...
+
Exclusive redirect URL patterns are typically more secure.  See xref:unspecific-redirect-uris[Unspecific Redirect URIs] for more information.
...
*OIDC CIBA Grant*:: If enabled, this client can use the OIDC xref:con-oidc-auth-flows[Client Initiated Backchannel Authentication Grant].
