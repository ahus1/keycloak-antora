...
+
.Create a profile
image:create-oidc-client-profile.png[Create Client Profile]
...
image:create-oidc-client-secret-rotation-executor.png[Client Profile Executor]
...
image:create-oidc-client-secret-rotation-policy.png[Client Rotation Policy]
...
image:create-oidc-client-secret-rotation-condition.png[Client Rotation Policy Condition]
...
image:oidc-client-secret-rotation-policy.png[Client Rotation Policy]
