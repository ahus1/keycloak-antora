...
image:user-events-settings.png[User events settings]
...
+
.Add types
image:add-event-types.png[Add types]
...
+
.User events
image:user-events.png[Login Events]

. To filter events, click *Search user event*.
+
.Search user event
image:search-user-event.png[Search user event]
...
+
.Event listeners
image:event-listeners.png[Event listeners]
