[id="proc_updating_client_scopes"]
...
When a client is created, you can unlink the default client scopes, if needed. This is similar to removing xref:assembly-roles-groups.adoc#_default_roles[Default Roles].
