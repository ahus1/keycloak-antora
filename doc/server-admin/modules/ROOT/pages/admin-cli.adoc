...
. Provide the `config` attributes: `clientId` and `clientSecret`. You can find these attributes in the Facebook Developers application configuration page for your application. See see the xref:identity-broker/social/facebook.adoc[facebook identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes: `clientId` and `clientSecret`. You can find these attributes in the Google Developers application configuration page for your application. See the xref:identity-broker/social/google.adoc[Google identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes `clientId` and `clientSecret`. You can find these attributes in the Twitter Application Management application configuration page for your application. See the xref:identity-broker/social/twitter.adoc[Twitter identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes `clientId` and `clientSecret`. You can find these attributes in the GitHub Developer Application Settings page for your application. See the xref:identity-broker/social/github.adoc[Github identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes `clientId` and `clientSecret`. You can find these attributes in the LinkedIn Developer Console application page for your application. See the xref:identity-broker/social/linked-in.adoc[LinkedIn identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes `clientId` and `clientSecret`. You can find these attributes in the Microsoft Application Registration Portal page for your application. See the xref:identity-broker/social/microsoft.adoc[Microsoft identity broker] page for more information.
+
For example:
+
[options="nowrap"]
...
. Provide the `config` attributes `clientId`, `clientSecret`, and `key`. You can find these attributes in the Stack Apps OAuth page for your application. See the xref:identity-broker/social/stack-overflow.adoc[Stack Overflow identity broker] page for more information.
+
For example:
+
[options="nowrap"]
