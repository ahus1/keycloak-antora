...
{project_name} manages WebAuthn credentials similarly to other credentials from xref:assembly-managing-users.adoc#ref-user-credentials[User credential management]:
