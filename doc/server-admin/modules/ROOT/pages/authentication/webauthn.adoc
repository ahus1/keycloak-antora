...
+
image:webauthn-browser-flow-required.png[Webauthn browser flow required]
+
...
+
image:webauthn-browser-flow-conditional.png[Webauthn browser flow conditional]
...
+
image:webauthn-browser-flow-conditional-with-OTP.png[WebAuthn browser flow conditional with OTP]
...
{project_name} manages WebAuthn credentials similarly to other credentials from xref:assembly-managing-users.adoc#ref-user-credentials_{context}[User credential management]:
...
.PasswordLess flow
image:webauthn-passwordless-flow.png[PasswordLess flow]
...
.LoginLess flow
image:webauthn-loginless-flow.png[LoginLess flow]
