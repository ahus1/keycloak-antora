...
// TODO: generate attributes below from antora-playbook.yml, or even better capture them when Antora Assembler passes tem on the command line.
...
include::server-admin/20.0/keycloak-server-administration.adoc[]
